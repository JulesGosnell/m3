  ...
  {:draft3
   (sort-vocab
    [["https://json-schema.org/draft-03/vocab/applicator"             "additionalItems"        (old->new check-property-additionalItems)                #{"$schema" "items"}]
     ...
     ["https://json-schema.org/draft-03/vocab/meta-data"              "default"                (old->new check-property-default)                        #{"$schema"}]
     ...
     ["https://json-schema.org/draft-03/vocab/validation"             "exclusiveMinimum"       (old->new check-property-exclusiveMinimum-old)           #{"$schema"}]
     ...
     ["https://json-schema.org/draft-03/vocab/validation"             "minimum"                (old->new check-property-minimum-old)                    #{"$schema"}]
   ...
   (sort-vocab
    [["https://json-schema.org/draft-04/vocab/applicator"             "additionalItems"        (old->new check-property-additionalItems)                #{"$schema" "items"}]
     ...
     ["https://json-schema.org/draft-04/vocab/meta-data"              "default"                (old->new check-property-default)                        #{"$schema"}]
     ["https://json-schema.org/draft-04/vocab/meta-data"              "deprecated"             (old->new check-property-deprecated)                     #{"$schema"}]
     ["https://json-schema.org/draft-04/vocab/meta-data"              "description"            (old->new check-property-description)                    #{"$schema"}]
     ["https://json-schema.org/draft-04/vocab/meta-data"              "title"                  (old->new check-property-title)                          #{"$schema"}]
     ["https://json-schema.org/draft-04/vocab/validation"             "enum"                   (old->new check-property-enum)                           #{"$schema"}]
     ["https://json-schema.org/draft-04/vocab/validation"             "exclusiveMaximum"       (old->new check-property-exclusiveMaximum-old)           #{"$schema"}]
     ["https://json-schema.org/draft-04/vocab/validation"             "exclusiveMinimum"       (old->new check-property-exclusiveMinimum-old)           #{"$schema"}]
     ...
     ["https://json-schema.org/draft-04/vocab/validation"             "minimum"                (old->new check-property-minimum-old)                    #{"$schema"}]
   ...
   (sort-vocab
    [["https://json-schema.org/draft-06/vocab/applicator"             "additionalItems"        (old->new check-property-additionalItems)                #{"$schema" "items"}]
     ...
     ["https://json-schema.org/draft-06/vocab/core"                   "id"                     (old->new check-property-id)                             #{"$schema"}]
     ["https://json-schema.org/draft-06/vocab/meta-data"              "default"                (old->new check-property-default)                        #{"$schema"}]
     ["https://json-schema.org/draft-06/vocab/meta-data"              "deprecated"             (old->new check-property-deprecated)                     #{"$schema"}]
     ["https://json-schema.org/draft-06/vocab/meta-data"              "description"            (old->new check-property-description)                    #{"$schema"}]
     ["https://json-schema.org/draft-06/vocab/meta-data"              "title"                  (old->new check-property-title)                          #{"$schema"}]
     ["https://json-schema.org/draft-06/vocab/validation"             "const"                  (old->new check-property-const)                          #{"$schema"}]
     ["https://json-schema.org/draft-06/vocab/validation"             "enum"                   (old->new check-property-enum)                           #{"$schema"}]
     ...
     ["https://json-schema.org/draft-06/vocab/validation"             "minimum"                (old->new check-property-minimum-new)                    #{"$schema"}]
   ...
   (sort-vocab
    [["https://json-schema.org/draft-07/vocab/applicator"             "additionalItems"        (old->new check-property-additionalItems)                #{"$schema" "items"}]
     ...
     ["https://json-schema.org/draft-07/vocab/core"                   "$comment"               (old->new check-property-$comment)                       #{"$schema"}]
     ...
     ["https://json-schema.org/draft-07/vocab/core"                   "id"                     (old->new check-property-id)                             #{"$schema"}]
     ["https://json-schema.org/draft-07/vocab/meta-data"              "default"                (old->new check-property-default)                        #{"$schema"}]
     ["https://json-schema.org/draft-07/vocab/meta-data"              "deprecated"             (old->new check-property-deprecated)                     #{"$schema"}]
     ["https://json-schema.org/draft-07/vocab/meta-data"              "description"            (old->new check-property-description)                    #{"$schema"}]
     ["https://json-schema.org/draft-07/vocab/meta-data"              "examples"               (old->new check-property-examples)                       #{"$schema"}]
     ["https://json-schema.org/draft-07/vocab/meta-data"              "readOnly"               (old->new check-property-readOnly)                       #{"$schema"}]
     ["https://json-schema.org/draft-07/vocab/meta-data"              "title"                  (old->new check-property-title)                          #{"$schema"}]
     ["https://json-schema.org/draft-07/vocab/meta-data"              "writeOnly"              (old->new check-property-writeOnly)                      #{"$schema"}]
     ["https://json-schema.org/draft-07/vocab/validation"             "const"                  (old->new check-property-const)                          #{"$schema"}]
     ["https://json-schema.org/draft-07/vocab/validation"             "enum"                   (old->new check-property-enum)                           #{"$schema"}]
     ...
     ["https://json-schema.org/draft-07/vocab/validation"             "minimum"                (old->new check-property-minimum-new)                    #{"$schema"}]
   ...
   (sort-vocab
    [["https://json-schema.org/draft/2019-09/vocab/applicator"        "additionalItems"        (old->new check-property-additionalItems)                #{"$schema" "items"}]
     ...
     ["https://json-schema.org/draft/2019-09/vocab/core"              "$comment"               (old->new check-property-$comment)                       #{"$schema"}]
     ...
     ["https://json-schema.org/draft/2019-09/vocab/core"              "$recursiveRef"          (old->new check-property-$recursiveRef)                  #{"$schema" "$recursiveAnchor"}]
     ...
     ["https://json-schema.org/draft/2019-09/vocab/core"              "$vocabulary"            (old->new check-property-$vocabulary)                    #{"$schema"}]
     ["https://json-schema.org/draft/2019-09/vocab/meta-data"         "default"                (old->new check-property-default)                        #{"$schema"}]
     ["https://json-schema.org/draft/2019-09/vocab/meta-data"         "deprecated"             (old->new check-property-deprecated)                     #{"$schema"}]
     ["https://json-schema.org/draft/2019-09/vocab/meta-data"         "description"            (old->new check-property-description)                    #{"$schema"}]
     ["https://json-schema.org/draft/2019-09/vocab/meta-data"         "examples"               (old->new check-property-examples)                       #{"$schema"}]
     ["https://json-schema.org/draft/2019-09/vocab/meta-data"         "readOnly"               (old->new check-property-readOnly)                       #{"$schema"}]
     ["https://json-schema.org/draft/2019-09/vocab/meta-data"         "title"                  (old->new check-property-title)                          #{"$schema"}]
     ["https://json-schema.org/draft/2019-09/vocab/meta-data"         "writeOnly"              (old->new check-property-writeOnly)                      #{"$schema"}]
     ["https://json-schema.org/draft/2019-09/vocab/validation"        "const"                  (old->new check-property-const)                          #{"$schema"}]
     ["https://json-schema.org/draft/2019-09/vocab/validation"        "dependentRequired"      (old->new check-property-dependentRequired)              #{"$schema"}]
     ["https://json-schema.org/draft/2019-09/vocab/validation"        "enum"                   (old->new check-property-enum)                           #{"$schema"}]
     ...
     ["https://json-schema.org/draft/2019-09/vocab/validation"        "minimum"                (old->new check-property-minimum-new)                    #{"$schema"}]
   ...
   (sort-vocab
    [["https://json-schema.org/draft/2020-12/vocab/applicator"        "additionalItems"        (old->new check-property-additionalItems)                #{"$schema" "items"}]
     ...
     ["https://json-schema.org/draft/2020-12/vocab/core"              "$comment"               (old->new check-property-$comment)                       #{"$schema"}]
     ...
     ["https://json-schema.org/draft/2020-12/vocab/core"              "$dynamicRef"            (old->new check-property-$dynamicRef)                    #{"$schema" "$dynamicAnchor"}]
     ...
     ["https://json-schema.org/draft/2020-12/vocab/core"              "$recursiveRef"          (old->new check-property-$recursiveRef)                  #{"$schema" "$recursiveAnchor"}]
     ...
     ["https://json-schema.org/draft/2020-12/vocab/core"              "$vocabulary"            (old->new check-property-$vocabulary)                    #{"$schema"}]
     ...
     ["https://json-schema.org/draft/2020-12/vocab/meta-data"         "default"                (old->new check-property-default)                        #{"$schema"}]
     ["https://json-schema.org/draft/2020-12/vocab/meta-data"         "deprecated"             (old->new check-property-deprecated)                     #{"$schema"}]
     ["https://json-schema.org/draft/2020-12/vocab/meta-data"         "description"            (old->new check-property-description)                    #{"$schema"}]
     ["https://json-schema.org/draft/2020-12/vocab/meta-data"         "examples"               (old->new check-property-examples)                       #{"$schema"}]
     ["https://json-schema.org/draft/2020-12/vocab/meta-data"         "readOnly"               (old->new check-property-readOnly)                       #{"$schema"}]
     ["https://json-schema.org/draft/2020-12/vocab/meta-data"         "title"                  (old->new check-property-title)                          #{"$schema"}]
     ["https://json-schema.org/draft/2020-12/vocab/meta-data"         "writeOnly"              (old->new check-property-writeOnly)                      #{"$schema"}]
     ...
     ["https://json-schema.org/draft/2020-12/vocab/validation"        "const"                  (old->new check-property-const)                          #{"$schema"}]
     ["https://json-schema.org/draft/2020-12/vocab/validation"        "dependentRequired"      (old->new check-property-dependentRequired)              #{"$schema"}]
     ["https://json-schema.org/draft/2020-12/vocab/validation"        "enum"                   (old->new check-property-enum)                           #{"$schema"}]
     ...
     ["https://json-schema.org/draft/2020-12/vocab/validation"        "minimum"                (old->new check-property-minimum-new)                    #{"$schema"}]
   ...
   (sort-vocab
    [["https://json-schema.org/draft/next/vocab/applicator"           "additionalItems"        (old->new check-property-additionalItems)                #{"$schema" "items"}]
     ...
     ["https://json-schema.org/draft/next/vocab/core"                 "$comment"               (old->new check-property-$comment)                       #{"$schema"}]
     ...
     ["https://json-schema.org/draft/next/vocab/core"                 "$dynamicRef"            (old->new check-property-$dynamicRef)                    #{"$schema" "$dynamicAnchor"}]
     ...
     ["https://json-schema.org/draft/next/vocab/core"                 "$recursiveRef"          (old->new check-property-$recursiveRef)                  #{"$schema" "$recursiveAnchor"}]
     ...
     ["https://json-schema.org/draft/next/vocab/core"                 "$vocabulary"            (old->new check-property-$vocabulary)                    #{"$schema"}]
     ...
     ["https://json-schema.org/draft/next/vocab/meta-data"            "default"                (old->new check-property-default)                        #{"$schema"}]
     ["https://json-schema.org/draft/next/vocab/meta-data"            "deprecated"             (old->new check-property-deprecated)                     #{"$schema"}]
     ["https://json-schema.org/draft/next/vocab/meta-data"            "description"            (old->new check-property-description)                    #{"$schema"}]
     ["https://json-schema.org/draft/next/vocab/meta-data"            "examples"               (old->new check-property-examples)                       #{"$schema"}]
     ["https://json-schema.org/draft/next/vocab/meta-data"            "readOnly"               (old->new check-property-readOnly)                       #{"$schema"}]
     ["https://json-schema.org/draft/next/vocab/meta-data"            "title"                  (old->new check-property-title)                          #{"$schema"}]
     ["https://json-schema.org/draft/next/vocab/meta-data"            "writeOnly"              (old->new check-property-writeOnly)                      #{"$schema"}]
     ...
     ["https://json-schema.org/draft/next/vocab/validation"           "const"                  (old->new check-property-const)                          #{"$schema"}]
     ["https://json-schema.org/draft/next/vocab/validation"           "dependentRequired"      (old->new check-property-dependentRequired)              #{"$schema"}]
     ["https://json-schema.org/draft/next/vocab/validation"           "enum"                   (old->new check-property-enum)                           #{"$schema"}]
     ...
     ["https://json-schema.org/draft/next/vocab/validation"           "minimum"                (old->new check-property-minimum-new)                    #{"$schema"}]
