...
(def exclude-test?
  #{;; I think we need $vocabulary working as the remote schema is draft7 but contains a dependentRequired in it...
    ...
    ["unevaluatedItems.json" "unevaluatedItems before $ref" "with no unevaluated items"]
    ...
    ["unevaluatedItems.json" "unevaluatedItems with items and additionalItems" "unevaluatedItems doesn't apply"]
    ["unevaluatedItems.json" "unevaluatedItems with items and prefixItems" "unevaluatedItems doesn't apply"]
    ["unevaluatedItems.json" "unevaluatedItems with items" "valid under items"]
    ["unevaluatedItems.json" "unevaluatedItems with nested items and additionalItems" "with additional items"]
    ["unevaluatedItems.json" "unevaluatedItems with nested items and additionalItems" "with no additional items"]
    ["unevaluatedItems.json" "unevaluatedItems with nested items" "with no additional items"]
    ["unevaluatedItems.json" "unevaluatedItems with nested prefixItems and items" "with additional items"]
    ["unevaluatedItems.json" "unevaluatedItems with nested prefixItems and items" "with no additional items"]
